...
| STFT | 语谱图 generator | Framed + windowed FFT; yields time × frequency matrix. |
...
- [Stevens, Volkmann, Newman (1937). A Scale for the Measurement of the Psychological Magnitude 音高](https://pubs.aip.org/asa/jasa/article-abstract/8/3/185/735757/) — the original mel scale.
