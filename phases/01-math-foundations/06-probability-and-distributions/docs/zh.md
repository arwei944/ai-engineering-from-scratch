...
> 概率 is the language AI uses to express uncertainty.
...
### Events, Sample Spaces, and 概率

The sample space S is the set of all possible outcomes. An event is a subset of the sample space. 概率 maps events to numbers between 0 and 1.
...
### Conditional 概率 and Independence
...
Continuous random variables have a probability density function (PDF). The density at a single point is not a probability. 概率 comes from integrating the density over an interval.
...
### Why the Normal 分布 Shows Up Everywhere
...
- 梯度 noise in SGD is approximately normal (sum of many sample gradients)
...
| Conditional probability | "概率 given something" | P(A\|B) = P(A and B) / P(B). The foundation of Bayesian thinking and Bayes' theorem |
...
- [Stanford CS229 概率 Review](https://cs229.stanford.edu/section/cs229-prob.pdf) - concise reference covering everything here and more
