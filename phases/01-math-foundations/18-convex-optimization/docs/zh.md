...
**类型:** 实现
**Language:** Python
**前置要求:** 阶段1, Lessons 04 (Calculus for ML), 08 (Optimization)
**Time:** ~90 minutes
...
- [Boyd & Vandenberghe: 凸优化](https://web.stanford.edu/~boyd/cvxbook/) - the standard textbook, freely available online
