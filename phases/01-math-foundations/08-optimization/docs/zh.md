...
**类型:** 实现
**Language:** Python
**前置要求:** 阶段1, Lessons 04-05 (Derivatives, Gradients)
**Time:** ~75 minutes
...
优化 is finding the input values that minimize (or maximize) a function. In machine learning, the function is the loss. The inputs are the model's weights. Training is optimization.
...
- [Adam: A Method for Stochastic 优化 (Kingma & Ba, 2014)](https://arxiv.org/abs/1412.6980) - the original Adam paper, readable and short
